...
st.set_page_config(page_title="Car Model Detection", page_icon="", layout="wide")
st.title(" Car Model Detection")

# Load model (path hidden from UI)
MODEL_PATH = "Motolite Car Model SAM3 new.pt"  # Replace with your actual .pt filename
...
if uploaded_video is not None:
    ...
    # Summary stats — shows each detected car model and its count
    st.subheader("Detected Car Models")
    ...
    with open(output_path, "rb") as f:
        st.download_button(
            ...
            data=f,
            file_name="car_model_detection_output.mp4",
            mime="video/mp4",
        )